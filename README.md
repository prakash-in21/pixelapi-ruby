# PixelAPI — Official Ruby SDK

Official Ruby SDK for [PixelAPI](https://pixelapi.dev) — *AI image, video, audio, and 3D API for builders.*
...
client = PixelAPI::Client.new("YOUR_KEY")
r = client.generate("product photo of red sneakers")
puts r["output_url"]
